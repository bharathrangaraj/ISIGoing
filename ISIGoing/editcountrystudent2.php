...
$info = mysqli_real_escape_string($conn, $_POST['studenttext']);
$info = strip_tags($info, "<b>, <i>, <em>, <hr>, <h1>, <h2>, <h3>, <h4>, <br>");
$infoEsc = $info;

$sql = "UPDATE country SET student='{$infoEsc}' WHERE IDCountry={$idC}";
//actually edit student part of a country
?>
<html>
    <head>
        <meta charset="UTF-8">
