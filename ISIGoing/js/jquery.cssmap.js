...
(function(a) {
    a.fn.cssMap = function(h) {
        var g = {size: "850", tooltips: true, tooltipArrowHeight: 5, cities: false, visibleList: false, visibleListContainerId: "", loadingText: "Loading ...", multipleClick: false, searchUrl: "search.php", searchLink: "Search", searchLinkVar: "region", searchLinkSeparator: "|", clicksLimit: 0, clicksLimitAlert: "You can select only %d region! || regions!", agentsListId: "", agentsListSpeed: 0, agentsListOnHover: false, pins: {enable: false, pinsId: "", markerClass: "cssmap-marker", pinTooltipClass: "cssmap-tooltip-content", markerPosition: "middle", tooltipPosition: "top", tooltipOnClick: false, tooltipFadeSpeed: 0, clickableRegions: true}, onClick: function(d) {
        ...
        if (h) {
            var c = a.extend(true, g, h || {}), f = a(window).width(), b = a(window).height();
            ...
            return this.each(function(o) {
                ...
                var s = "#" + a(this).attr("id"), k = a(s), i = k.find("ul").eq(0), j = a(i).attr("class").split(" ")[0], t = a(i).find("li"), d = a(m).find("li"), n = 0, r = false, l = "", v = "", q = c.tooltips.toString(), u = c.pins.clickableRegions.toString(), p = {init: function() {
                        p.clearMap();
                        k.addClass("css-map-container m" + c.size);
                        var w = i.css("background-image").replace(/^url\("?([^\"\))]+)"?\)$/i, "$1");
                        this.loader(w)
                    }, loader: function(z) {
                        var y = new Image(), w = a("<span />", {"class": "map-loader", text: c.loadingText}).appendTo(k), x = {left: k.outerWidth() / 2, marginLeft: w.outerWidth() / -2, marginTop: w.outerHeight() / -2, top: k.outerHeight() / 2};
                        w.css(x);
                        ...
                        a(y).load(function() {
                            ...
                            w.hideTooltips();
                            t.each(function() {
                                var y = a(this), z = y.attr("class").split(" ")[0], A = y.children("A").eq(0), x = a(A).attr("href");
                            ...
                            if (q == "true" || q == "sticky" || q == "visible") {
                                var x = i.outerWidth(), C = parseInt(a(B).outerHeight() * -1) - c.tooltipArrowHeight, z = parseInt(a(B).outerHeight() / -2), F = parseInt(a(B).outerWidth() / -2), E = a(B).position().left, A = a(B).position().top;
                                if ((F * -1) > E) {
                                ...
                                if (q.split("-")[0] == "floating") {
                                    var w = a(B).html(), D = a("<div />", {id: "map-tooltip", html: w}).appendTo("body")
                                }
                            }
                        ...
                        }}, selectRegion: {init: function(x, w, C) {
                            ...
                            t.each(function() {
                                var A = a(this).children("A"), z = A.attr("href"), y;
                        ...
                        var w = p.selectRegion, x = a("<a />", {href: c.searchUrl, "class": "map-search-link", text: c.searchLink});
                        a(i).after(x);
                        x.hover(function() {
                            w.multiple()
                        }).focus(function() {
                            ...
                            var y = k.position().top, w = a(i).position().left, z = a(i).outerWidth(), x = parseInt(z / -2), A = a(i).outerHeight(), B = {height: A, left: "50%", marginLeft: x, position: "absolute", top: y, width: z};
                            a(m).css(B);
                            d.each(function() {
                                var R = a(this);
                                p.pins.pinContent(R);
                                var E = R.find("." + c.pins.markerClass).eq(0), C = R.find("." + c.pins.pinTooltipClass).eq(0), S = E.attr("href"), N = R.attr("data-cssmap-coords").split(","), O = parseInt(N[0]), L = parseInt(N[1]), G = E.outerWidth(), M = parseInt(G / -2), Q = parseInt(E.outerHeight()), P = C.outerHeight(), D = C.outerWidth(), K = parseInt(D / -2), H = function() {
                                    ...
                                    return T
                                }, F = {left: O, marginLeft: M, position: "absolute", textAlign: "center", top: H(), zIndex: 200}, I = {display: "block", left: O, marginLeft: K, marginTop: "-9999em", opacity: 0, position: "absolute", top: J(), zIndex: 201};
                                E.css(F);
                                C.css(I);
                            ...
                            if (!y.length) {
                                var x = a("<a />", {"class": c.pins.markerClass, href: "#", text: ""}).appendTo(z)
                            }
                        }, pinOpen: function(y, w, x) {
                            a(m).find(".hide-tooltip").each(function() {
                                var B = a(this), z = B.find("." + c.pins.markerClass), A = B.find("." + c.pins.pinTooltipClass), C = z.outerWidth();
                                p.pins.pinClose(B, z, A)
                            });
                            y.addClass("hide-tooltip");
                            x.css("margin-top", 0).animate({opacity: 1}, c.pins.tooltipFadeSpeed)
                        }, pinClose: function(y, w, x) {
                            y.removeClass("hide-tooltip");
                            x.animate({opacity: 0}, c.pins.tooltipFadeSpeed, function() {
